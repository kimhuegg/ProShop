...
import {
    ...
    InputLabel, Input
} from '@mui/material'; import { useNavigate, Link } from 'react-router-dom';
                ...
                <Grid container>
                    ...
                    <Grid item xs={6} sx={{ bgcolor: '#FAF096' }} container alignItems={'start'}>
                        <Grid sx={{ height: '30px' }} container justifyContent="end">
                            <Button onClick={onClose} variant='contained' color='white' sx={{ boxSizing: 'border-box', p:0,borderRadius: '50%', m: 1, p: 0, height: '60px', width: '30px', boxShadow: '5px 5px 10px rgba(0, 0, 0, 0.25)' }}>x</Button>
                        </Grid>
